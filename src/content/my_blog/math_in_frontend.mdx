...
various areas of mathematics. But what about practical side?
...
We use class methods or transparent functions if we are writing in a
functional style(or using a [functional programming](https://en.wikipedia.org/wiki/Functional_programming)).
...
Previously, we placed state of a web application to the foreground.
...
But these are more special cases, perhaps. The main idea of this article
...
I think you can be a good front-end developer without deep knowledge of mathematics.
